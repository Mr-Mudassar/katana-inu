...
const CallToAction = () => {
  return (
    <div className="py-2 px-3 lg:py-[32px] lg:px-[90px]">
      <div className="relative h-[440px] xl:h-[400px]  mt-8 mb-0 lg:mb-14 z-50 border border-Background">
        <div className="subscribe-section-1  h-[440px] m:h-[600px] xl:h-[300px] mt-0 xl:mt-[100px] overflow-hidden">
