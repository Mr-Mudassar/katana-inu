...
const FooterTopPart = () => {
  return (
      <div className="text-center">
        <h3 className="text-white text-5xl font-semibold mt-8 font-[jost]">
          Katana Inu is a <span className="text-Default">MMO NFT PC Game</span>
        </h3>
        <p className="text-CustomLight mt-8 text-xl">
        ...
        <div className="flex justify-center flex-wrap mt-8">
          <button className="bg-Default mx-1 py-2 px-4  rounded-md text-CustomFontColor  text-xl font-bold">
            <div className="flex">
              <p>PLAY KATANAINU</p>
          ...
          <button className="border border-Default mx-1 py-2 px-4  text-xl font-semibold rounded-md text-white">
            <div className="flex">
              <p>BUY $KATA TOKENU</p>
              <GoArrowUpRight size={28} />
            </div>
